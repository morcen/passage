 ...
 *
 * return [
 *     'service' => [Guzzle request options] | Controller::class
 * ];
 *
 * Wherein:
 * - "service" is the part of the URL that determines when the external URL will be called.
 * - [Guzzle request options] is an array containing the request options for the Guzzle client (see https://docs.guzzlephp.org/en/stable/request-options.html)
 * - Controller::class is the passage controller that will handle the request (generated by `php artisan passage:controller` command)
 *
 * For example:
 * return [
 *     'github' => [
